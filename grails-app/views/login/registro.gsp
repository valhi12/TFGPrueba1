                ...
                <div class="registro-grid">
                    ...
                    <div class="campo">
                        ...
                        <div style="position:relative; width:100%; display:block; margin-bottom:0;">
                            ...
                            <button type="button" id="btnOjoPass1" onclick="toggleOjo('password','svgOjoPass1')" tabindex="-1"
                                ...
                                <svg id="svgOjoPass1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 256 256" style="display:block; fill:#6b5e52; opacity:0.6;">
                    ...
                    <div class="campo">
                        ...
                        <div style="position:relative; width:100%; display:block; margin-bottom:0;">
                            <input type="password" id="password2" placeholder="Repite tu contraseña"
                                   style="width:100%; padding:11px 44px 11px 16px; border:1.5px solid #dde8db; border-radius:10px; font-family:'Nunito',sans-serif; font-size:0.95rem; color:#4a4a4a; background:#e8f2e6; outline:none; box-sizing:border-box; margin-bottom:0;"/>
                            <button type="button" id="btnOjoPass2" onclick="toggleOjo('password2','svgOjoPass2')" tabindex="-1"
                                    style="position:absolute; right:10px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; padding:4px; line-height:0;">
                                <svg id="svgOjoPass2" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 256 256" style="display:block; fill:#6b5e52; opacity:0.6;">
                                    <path d="M247.31,124.76c-.35-.79-8.82-19.58-27.65-38.41C194.57,61.26,162.88,48,128,48S61.43,61.26,36.34,86.35C17.51,105.18,9,124,8.69,124.76a8,8,0,0,0,0,6.5c.35.79,8.82,19.57,27.65,38.4C61.43,194.74,93.12,208,128,208s66.57-13.26,91.66-38.34c18.83-18.83,27.3-37.61,27.65-38.4A8,8,0,0,0,247.31,124.76ZM128,192c-30.78,0-57.67-11.19-79.93-33.25A133.47,133.47,0,0,1,25,128,133.33,133.33,0,0,1,48.07,97.25C70.33,75.19,97.22,64,128,64s57.67,11.19,79.93,33.25A133.46,133.46,0,0,1,231.05,128C223.84,141.46,192.43,192,128,192Zm0-112a48,48,0,1,0,48,48A48.05,48.05,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32,32,0,0,1,128,160Z"/>
                                </svg>
                            </button>
                        </div>
